...
void solve(){
    ...
    // convert string into vector array 

    vector<int> first_num;
    vector<int> second_num;

    for(int i = 0; i<num1.size(); i++){
        first_num.push_back(num1[i] - '0');
    }
    for(int i = 0; i<num2.size(); i++){
        second_num.push_back(num2[i] - '0');
    }
    // vector<int> sum = add(first_num, second_num);
    ...
    //vector<int> quo = divide(first_num, 1);
    ...
    // vector<int> diff = subtract(first_num, second_num);
    // for(int i = 0; i<diff.size(); i++){
    //     cout<<diff[i];
    // }

    vector<int> remainder = modulo(first_num, 3);
